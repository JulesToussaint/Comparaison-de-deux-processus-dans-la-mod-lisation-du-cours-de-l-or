...
![equation](https://latex.codecogs.com/svg.image?$$dX_t=\mu&space;X_t&space;dt&plus;\sigma&space;dW_t,\quad&space;X_0$$)
...
![equation](https://latex.codecogs.com/svg.image?$$dY_t=\kappa(\theta-Y_t)dt&plus;\sigma&space;dW_t,\quad&space;Y_0$$)
