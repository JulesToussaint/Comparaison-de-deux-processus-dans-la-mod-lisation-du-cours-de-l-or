...
![equation](https://latex.codecogs.com/png.image?\dpi{110}dX_t=\mu X_t dt+\sigma X_t dW_t)
...
![equation](https://latex.codecogs.com/png.image?\dpi{110}dY_t=\kappa(\theta-Y_t)dt+\sigma dW_t)
